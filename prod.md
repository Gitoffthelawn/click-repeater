...
5. Push the tag. GitHub Actions validates the tag, manifest, and CHANGELOG, then builds `click-repeater.zip` with the central `browser-extension-ci-cd` tool and publishes the GitHub Release.
