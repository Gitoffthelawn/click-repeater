// LOCALES, LOCALE_LABELS, TRANSLATIONS, EN_MESSAGES, normalizeLocale come from
// app/i18n.js; isRtlLocale from lib/our/i18n/rtl.js; welcomeStepIcon from
// lib/our/welcome/step-icon.js; ext from lib/our/api.js. Those files are also
// loaded as classic scripts on the welcome/popup pages, so they bridge these
// symbols onto globalThis instead of using ES `export`.
const ext = globalThis.ext;
const LOCALES = globalThis.LOCALES;
const LOCALE_LABELS = globalThis.LOCALE_LABELS;
...
const welcomeStepIcon = globalThis.welcomeStepIcon;
